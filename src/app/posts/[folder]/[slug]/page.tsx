...
const Post = async (props:any) => {
    ...
    return (
        ...
        {post.data.subtitle}
            ...
            <article className="p-2 h-1/2 rounded-md  w-11/12 lg:w-2/3 mx-auto mb-4  prose max-w-none prose-p:text-xl prose-a:text-sky-800 prose-h2:text-sky-900 font-normal">
            <h2>Table of Contents</h2>
            <Markdown 
            remarkPlugins={[remarkGfm]}>{post.toc}</Markdown>
            </article>

            <article className="prose w-11/12 lg:w-2/3 max-w-none lg:prose-base mx-auto prose-p:text-lg prose-blockquote:not-italic prose-blockquote:text-slate-700 prose-quoteless call hl">
           <Markdown
           components={{
            h1(props) {
